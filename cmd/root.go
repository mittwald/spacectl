...
func init() {
	...
	RootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.spacectl.yaml)")
...
func initConfig() {
	...
	viper.SetConfigName(".spacectl") // name of config file (without extension)
